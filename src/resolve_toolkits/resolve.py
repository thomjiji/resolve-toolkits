...
class Resolve:
    ...
    def get_timeline_by_name(self, timeline_name: str) -> Timeline:
        ...
        timeline_dict = {timeline.GetName(): timeline for timeline in all_timeline}  # type: ignore
    ...
    def get_subfolder_by_name(self, subfolder_name: str) -> Folder:
        ...
        subfolder_dict: Dict[str, Folder] = {subfolder.GetName(): subfolder for subfolder in all_subfolder}
