usage: dailies.py [-h] input output

dailies is a commandline tool to automatic import clips, create timelines, add to render queue using the predefined preset.
